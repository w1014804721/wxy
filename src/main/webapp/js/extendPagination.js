        ...
        if (totalPage > 0) {
            ...
            if (totalPage <= showPage) {
                for (var i = 1; i <= totalPage; i++) {
                    if (i == 1) html.push(' <li class="active"><a href="#" onclick="returnId('+i+')">' + i + '</a></li>');
                    else html.push(' <li><a href="#" onclick="returnId('+i+')">' + i + '</a></li>');
                }
            } else {
                for (var j = 1; j <= showPage; j++) {
                    if (j == 1) html.push(' <li class="active"><a href="#" onclick="returnId('+j+')">' + j + '</a></li>');
                    else html.push(' <li><a href="#" onclick="returnId('+j+')">' + j + '</a></li>');
                }
            }
            html.push('<li class="disabled hidden"><a href="#">...</a></li>');
...
function returnId(id){
    ...
    {
        createActivities(id,pubactTotal,1);
    }
}